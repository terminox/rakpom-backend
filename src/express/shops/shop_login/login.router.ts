...
import ShopLoginController, { LoginValidator, LoginUser } from './login.controller'
...
export default class LoginRouter {
  ...
  private controller: ShopLoginController 

  constructor(controller: ShopLoginController) {
  ...
  static makeDefaultRouter(): LoginRouter {
    ...
    const controller = new ShopLoginController(store, hasher, service, encoder)
